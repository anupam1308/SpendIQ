...
function Sidebar() {
  ...
  return (
    <aside className="desktop-only w-[240px] h-screen sticky top-0 bg-white border-r border-[#e2efe8] px-4 py-6 flex-col justify-between shrink-0 shadow-xs">
      ...
      <div>
        ...
        <nav className="space-y-1.5">
          ...
          >
            ...
            <span className="text-[10px] font-extrabold uppercase px-1.5 py-0.5 rounded-md bg-[#245c4a]/10 text-[#245c4a]">
              AI
            </span>
          </NavLink>
        </nav>
      ...
      <div className="pt-4">
        <button
          ...
          className="w-full flex items-center justify-between p-3.5 rounded-2xl bg-white border border-[#245c4a]/25 hover:bg-[#eef6f2]/60 hover:border-[#245c4a]/40 transition-all duration-150 text-left shadow-xs"
        >
          <div className="flex items-center gap-3">
